...
typedef DayTextStylePredicate = TextStyle? Function({required DateTime date});
...
class CalendarDatePicker2WithActionButtonsConfig
  ...
  CalendarDatePicker2WithActionButtonsConfig({
    ...
    super.lastMonthIcon,
    super.hideLastMonthIcon,
    super.nextMonthIcon,
    super.hideNextMonthIcon,
    super.controlsTextStyle,
    super.animateToDisplayedMonthDate,
    super.semanticsDictionary,
    super.disableVibration,
