...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color disabledDayColor = colorScheme.onSurface.withValues(
      alpha: 0.38,
    );
      ...
      if (day < 1) {
        ...
        if (isDateInBetweenRangePickerSelectedDates) {
          ...
          var rangePickerIncludedDayDecoration = BoxDecoration(
            color:
                widget.config.selectedRangeHighlightColor ??
                (widget.config.selectedDayHighlightColor ??
                        selectedDayBackground)
          ...
          final rangePickerIncludedDayHighlight = widget
              .config
