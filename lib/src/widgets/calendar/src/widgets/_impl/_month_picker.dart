...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void initState() {
    ...
    _scrollController =
        widget.config.monthViewController ??
  ...
  Widget _buildMonthItem(BuildContext context, int index) {
    ...
    final monthSelectableFromPredicate =
        widget.config.selectableMonthPredicate?.call(
    ...
    if (isSelected) {
      decoration = BoxDecoration(
        ...
        borderRadius:
            widget.config.monthBorderRadius ??
    ...
    Widget monthItem =
        widget.config.monthBuilder?.call(
          month: month,
          textStyle: itemStyle,
    ...
    if (!isMonthSelectable) {
      ...
      monthItem = InkWell(
        ...
        onTap: !isMonthSelectable
            ...
            : () {
                widget.onChanged(
                  DateUtils.dateOnly(DateTime(widget.initialMonth.year, month)),
                );
              },
        child: monthItem,
      );
