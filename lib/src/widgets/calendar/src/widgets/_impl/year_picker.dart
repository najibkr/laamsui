...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    ...
    _scrollController =
        widget.config.yearViewController ??
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    final isDisabled =
        (year < widget.config.firstDate.year ||
    ...
    if (isSelected) {
      decoration = BoxDecoration(
        ...
        borderRadius:
            widget.config.yearBorderRadius ??
    ...
    Widget yearItem =
        widget.config.yearBuilder?.call(
          year: year,
          textStyle: itemStyle,
    ...
    if (isDisabled) {
      ...
      yearItem = InkWell(
        ...
        onTap: () =>
            widget.onChanged(DateTime(year, widget.initialMonth.month)),
        child: yearItem,
      );
    }
